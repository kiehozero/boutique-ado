...
class Order(models.Model):
    ...
    def _generate_order_number(self):
        ...
        """ The underscore prefix indicates that this method will
        only be used inside the class it is within """
    ...
    def save(self, *args, **kwargs):
        """ Overrides default save method to set the
...
class OrderLineItem(models.Model):
    ...
    product_size = models.CharField(
        max_length=2, null=True, blank=True)  # 2-char size codes
